          ...
          <div class="col-md-4">
            <div class="m-widget16__body" v-show="!isLoading">
              ...
              <div class="m-widget16__item">
                <span class="m-widget16__date">Fill Rate</span>
                <span class="m-widget16__price m--align-right m--font-brand">{{ percentage }}</span>
              </div>
              <!--end::widget item-->
              <!--begin::widget item-->
              <div class="m-widget16__item">
                <span class="m-widget16__date">Filled Slots</span>
                <span class="m-widget16__price m--align-right m--font-success">{{ filled }}</span>
              </div>
              <!--end::widget item-->
              <!--begin::widget item-->
              <div class="m-widget16__item">
                <span class="m-widget16__date">Empty Slots</span>
                <span class="m-widget16__price m--align-right m--font-danger">{{ empty }}</span>
              </div>
              <!--end::widget item-->
            </div>
          </div>
