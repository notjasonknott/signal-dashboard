    ...
    c=function() {
        0!=$("#m_chart_support_tickets").length&&Morris.Donut( {
            element:"m_chart_support_tickets", data:[ {
                label: "Filled", value: 164
            }
            , {
                label: "Empty", value: 38
            }
            ], labelColor:"#a7a7c2", colors:[mUtil.getColor("success"), mUtil.getColor("danger"), mUtil.getColor("danger")]
        }
        )
    }
    ,
        ...
        if(0!=$("#m_chart_adwords_stats").length) {
            ...
            var a= {
                ...
                data: {
                    ...
                    "October"],
                    datasets:[ {
                        label: "CTR", backgroundColor: mUtil.getColor("brand"), borderColor: mUtil.getColor("brand"), pointBackgroundColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointBorderColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointHoverBackgroundColor: mUtil.getColor("danger"), pointHoverBorderColor: Chart.helpers.color("#000000").alpha(.1).rgbString(), data: [12, 12, 9, 14, 13, 12, 10, 12, 15, 17]
                    }
                    ,
                    {
                        label: "Registration", backgroundColor: mUtil.getColor("accent"), borderColor: mUtil.getColor("accent"), pointBackgroundColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointBorderColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointHoverBackgroundColor: mUtil.getColor("danger"), pointHoverBorderColor: Chart.helpers.color("#000000").alpha(.1).rgbString(), data: [10, 14, 12, 16, 9, 11, 13, 9, 13, 15]
                    }
                    ,
                    {
                        label: "Purchase", backgroundColor: mUtil.getColor("success"), borderColor: mUtil.getColor("success"), pointBackgroundColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointBorderColor: Chart.helpers.color("#000000").alpha(0).rgbString(), pointHoverBackgroundColor: mUtil.getColor("danger"), pointHoverBorderColor: Chart.helpers.color("#000000").alpha(.1).rgbString(), data: [3, 1, 1, 6, 2, 1, 3, 0, 3, 5]
                    }
                    ]
                }
                ,
