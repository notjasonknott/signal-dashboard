<template>
  <div
    class="m-portlet m-portlet--full-height m-portlet--skin-light m-portlet--fit m-portlet--rounded"
  >
          ...
          >
            ...
            <div class="m-dropdown__wrapper">
              <span
                ...
                style="left: auto; right: 39px;"
              ></span>
              <div class="m-dropdown__inner">
                <div class="m-dropdown__body">
                  <div class="m-dropdown__content">
                    <ul class="m-nav">
                      <li v-for="menuItem in menu.list" :key="menuItem" class="m-nav__item">
          ...
          <div class="col-md-4">
            <div class="m-widget21__item">
              <div class="m-widget21__info">
                <span class="m-widget21__title m--font-brand">{{ this.graphData1['title'] }}</span>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="m-widget21__item">
              <div class="m-widget21__info">
                <span class="m-widget21__title m--font-info">{{ this.graphData2['title'] }}</span>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="m-widget21__item">
              <div class="m-widget21__info">
                <span class="m-widget21__title m--font-success">{{ this.graphData3['title'] }}</span>
              </div>
            </div>
          </div>
        </div>
